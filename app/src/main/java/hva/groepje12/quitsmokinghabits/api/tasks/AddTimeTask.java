...
public class AddTimeTask implements Task {
    private OnLoopJEvent listener;

    private static final String TAG = "PAD_API";

    public AddTimeTask(OnLoopJEvent listener) {
        this.listener = listener;
    }

    public void execute(RequestParams params) {
        PadRestClient.post("notification/add_time", params, new JsonHttpResponseHandler() {
            @Override
